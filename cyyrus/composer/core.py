...
class Composer:
    """
    A class responsible for managing dataset snapshots in a distributed computing environment using Ray.

    Attributes:
        dataset_name (str): Name of the dataset.
        snapshot_dir (str): Directory where snapshots are stored.
        records (list): Buffer holding records to be written to disk.
        row_limit (int): Maximum number of records per snapshot file.

    Methods:
        add_record(record): Adds a record to the buffer and flushes if limit is exceeded.
        reset(): Flushes current records to a snapshot file.
    """
